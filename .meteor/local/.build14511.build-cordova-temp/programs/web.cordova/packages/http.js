...
HTTP = {};                                                                                                            // 35
                                                                                                                      // 36
HTTP.get = function (/* varargs */) {                                                                                 // 37
  return HTTP.call.apply(this, ["GET"].concat(_.toArray(arguments)));                                                 // 38
};                                                                                                                    // 39
                                                                                                                      // 40
HTTP.post = function (/* varargs */) {                                                                                // 41
  return HTTP.call.apply(this, ["POST"].concat(_.toArray(arguments)));                                                // 42
};                                                                                                                    // 43
                                                                                                                      // 44
HTTP.put = function (/* varargs */) {                                                                                 // 45
  return HTTP.call.apply(this, ["PUT"].concat(_.toArray(arguments)));                                                 // 46
};                                                                                                                    // 47
                                                                                                                      // 48
HTTP.del = function (/* varargs */) {                                                                                 // 49
  return HTTP.call.apply(this, ["DELETE"].concat(_.toArray(arguments)));                                              // 50
};                                                                                                                    // 51
                                                                                                                      // 52
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
