...
_.extend(Connection.prototype, {                                                                                  // 426
  ...
  subscribe: function (name /* .. [arguments] .. (callback|callbacks) */) {                                       // 463
    ...
    if (existing) {                                                                                               // 502
      ...
      self._subscriptions[id] = {                                                                                 // 523
        ...
        inactive: false,                                                                                          // 527
        ready: false,                                                                                             // 528
        readyDeps: new Tracker.Dependency,                                                                        // 529
  ...
  _lostConnection: function () {                                                                                  // 925
    ...
    self._stream._lostConnection();                                                                               // 927
                                                                                                                  ...
                                                                                                                  // 929
  /**                                                                                                             // 930
   * @summary Get the current connection status. A reactive data source.                                          // 931
   * @locus Client                                                                                                // 932
   * @memberOf Meteor                                                                                             // 933
   */                                                                                                             // 934
  status: function (/*passthrough args*/) {                                                                       // 935
    var self = this;                                                                                              // 936
    return self._stream.status.apply(self._stream, arguments);                                                    // 937
  },                                                                                                              // 938
                                                                                                                  // 939
  /**                                                                                                             // 940
   * @summary Force an immediate reconnection attempt if the client is not connected to the server.               // 941
                                                                                                                  // 942
  This method does nothing if the client is already connected.                                                    // 943
   * @locus Client                                                                                                // 944
   * @memberOf Meteor                                                                                             // 945
   */                                                                                                             // 946
  reconnect: function (/*passthrough args*/) {                                                                    // 947
    var self = this;                                                                                              // 948
    return self._stream.reconnect.apply(self._stream, arguments);                                                 // 949
  },                                                                                                              // 950
                                                                                                                  // 951
  /**                                                                                                             // 952
   * @summary Disconnect the client from the server.                                                              // 953
   * @locus Client                                                                                                // 954
   * @memberOf Meteor                                                                                             // 955
   */                                                                                                             // 956
  disconnect: function (/*passthrough args*/) {                                                                   // 957
    var self = this;                                                                                              // 958
    return self._stream.disconnect.apply(self._stream, arguments);                                                // 959
  },                                                                                                              // 960
                                                                                                                  // 961
  close: function () {                                                                                            // 962
    var self = this;                                                                                              // 963
    return self._stream.disconnect({_permanent: true});                                                           // 964
  },                                                                                                              // 965
                                                                                                                  // 966
  ///                                                                                                             // 967
  /// Reactive user system                                                                                        // 968
  ///                                                                                                             // 969
  userId: function () {                                                                                           // 970
    var self = this;                                                                                              // 971
    if (self._userIdDeps)                                                                                         // 972
      self._userIdDeps.depend();                                                                                  // 973
    return self._userId;                                                                                          // 974
  },                                                                                                              // 975
                                                                                                                  // 976
  setUserId: function (userId) {                                                                                  // 977
    var self = this;                                                                                              // 978
    // Avoid invalidating dependents if setUserId is called with current value.                                   // 979
    if (self._userId === userId)                                                                                  // 980
      return;                                                                                                     // 981
    self._userId = userId;                                                                                        // 982
    if (self._userIdDeps)                                                                                         // 983
      self._userIdDeps.changed();                                                                                 // 984
  },                                                                                                              // 985
                                                                                                                  // 986
  // Returns true if we are in a state after reconnect of waiting for subs to be                                  // 987
  // revived or early methods to finish their data, or we are waiting for a                                       // 988
  // "wait" method to finish.                                                                                     // 989
  _waitingForQuiescence: function () {                                                                            // 990
    var self = this;                                                                                              // 991
    return (! _.isEmpty(self._subsBeingRevived) ||                                                                // 992
            ! _.isEmpty(self._methodsBlockingQuiescence));                                                        // 993
  },                                                                                                              // 994
                                                                                                                  // 995
  // Returns true if any method whose message has been sent to the server has                                     // 996
  // not yet invoked its user callback.                                                                           // 997
  _anyMethodsAreOutstanding: function () {                                                                        // 998
    var self = this;                                                                                              // 999
    return _.any(_.pluck(self._methodInvokers, 'sentMessage'));                                                   // 1000
  },                                                                                                              // 1001
                                                                                                                  // 1002
  _livedata_connected: function (msg) {                                                                           // 1003
    var self = this;                                                                                              // 1004
                                                                                                                  // 1005
    if (self._version !== 'pre1' && self._heartbeatInterval !== 0) {                                              // 1006
      self._heartbeat = new Heartbeat({                                                                           // 1007
        heartbeatInterval: self._heartbeatInterval,                                                               // 1008
        heartbeatTimeout: self._heartbeatTimeout,                                                                 // 1009
        onTimeout: function () {                                                                                  // 1010
          if (Meteor.isClient && ! self._stream._isStub) {                                                        // 1011
            // only print on the client. this message is useful on the                                            // 1012
            // browser console to see that we've lost connection. on the                                          // 1013
            // server (eg when doing server-to-server DDP), it gets                                               // 1014
            // kinda annoying. also this matches the behavior with                                                // 1015
            // sockjs timeouts.                                                                                   // 1016
            Meteor._debug("Connection timeout. No DDP heartbeat received.");                                      // 1017
          }                                                                                                       // 1018
          self._lostConnection();                                                                                 // 1019
        },                                                                                                        // 1020
        sendPing: function () {                                                                                   // 1021
          self._send({msg: 'ping'});                                                                              // 1022
        }                                                                                                         // 1023
      });                                                                                                         // 1024
      self._heartbeat.start();                                                                                    // 1025
    }                                                                                                             // 1026
                                                                                                                  // 1027
    // If this is a reconnect, we'll have to reset all stores.                                                    // 1028
    if (self._lastSessionId)                                                                                      // 1029
      self._resetStores = true;                                                                                   // 1030
                                                                                                                  // 1031
    if (typeof (msg.session) === "string") {                                                                      // 1032
      var reconnectedToPreviousSession = (self._lastSessionId === msg.session);                                   // 1033
      self._lastSessionId = msg.session;                                                                          // 1034
    }                                                                                                             // 1035
                                                                                                                  // 1036
    if (reconnectedToPreviousSession) {                                                                           // 1037
      // Successful reconnection -- pick up where we left off.  Note that right                                   // 1038
      // now, this never happens: the server never connects us to a previous                                      // 1039
      // session, because DDP doesn't provide enough data for the server to know                                  // 1040
      // what messages the client has processed. We need to improve DDP to make                                   // 1041
      // this possible, at which point we'll probably need more code here.                                        // 1042
      return;                                                                                                     // 1043
    }                                                                                                             // 1044
                                                                                                                  // 1045
    // Server doesn't have our data any more. Re-sync a new session.                                              // 1046
                                                                                                                  // 1047
    // Forget about messages we were buffering for unknown collections. They'll                                   // 1048
    // be resent if still relevant.                                                                               // 1049
    self._updatesForUnknownStores = {};                                                                           // 1050
                                                                                                                  // 1051
    if (self._resetStores) {                                                                                      // 1052
      // Forget about the effects of stubs. We'll be resetting all collections                                    // 1053
      // anyway.                                                                                                  // 1054
      self._documentsWrittenByStub = {};                                                                          // 1055
      self._serverDocuments = {};                                                                                 // 1056
    }                                                                                                             // 1057
                                                                                                                  // 1058
    // Clear _afterUpdateCallbacks.                                                                               // 1059
    self._afterUpdateCallbacks = [];                                                                              // 1060
                                                                                                                  // 1061
    // Mark all named subscriptions which are ready (ie, we already called the                                    // 1062
    // ready callback) as needing to be revived.                                                                  // 1063
    // XXX We should also block reconnect quiescence until unnamed subscriptions                                  // 1064
    //     (eg, autopublish) are done re-publishing to avoid flicker!                                             // 1065
    self._subsBeingRevived = {};                                                                                  // 1066
    _.each(self._subscriptions, function (sub, id) {                                                              // 1067
      if (sub.ready)                                                                                              // 1068
        self._subsBeingRevived[id] = true;                                                                        // 1069
    });                                                                                                           // 1070
                                                                                                                  // 1071
    // Arrange for "half-finished" methods to have their callbacks run, and                                       // 1072
    // track methods that were sent on this connection so that we don't                                           // 1073
    // quiesce until they are all done.                                                                           // 1074
    //                                                                                                            // 1075
    // Start by clearing _methodsBlockingQuiescence: methods sent before                                          // 1076
    // reconnect don't matter, and any "wait" methods sent on the new connection                                  // 1077
    // that we drop here will be restored by the loop below.                                                      // 1078
    self._methodsBlockingQuiescence = {};                                                                         // 1079
    if (self._resetStores) {                                                                                      // 1080
      _.each(self._methodInvokers, function (invoker) {                                                           // 1081
        if (invoker.gotResult()) {                                                                                // 1082
          // This method already got its result, but it didn't call its callback                                  // 1083
          // because its data didn't become visible. We did not resend the                                        // 1084
          // method RPC. We'll call its callback when we get a full quiesce,                                      // 1085
          // since that's as close as we'll get to "data must be visible".                                        // 1086
          self._afterUpdateCallbacks.push(_.bind(invoker.dataVisible, invoker));                                  // 1087
        } else if (invoker.sentMessage) {                                                                         // 1088
          // This method has been sent on this connection (maybe as a resend                                      // 1089
          // from the last connection, maybe from onReconnect, maybe just very                                    // 1090
          // quickly before processing the connected message).                                                    // 1091
          //                                                                                                      // 1092
          // We don't need to do anything special to ensure its callbacks get                                     // 1093
          // called, but we'll count it as a method which is preventing                                           // 1094
          // reconnect quiescence. (eg, it might be a login method that was run                                   // 1095
          // from onReconnect, and we don't want to see flicker by seeing a                                       // 1096
          // logged-out state.)                                                                                   // 1097
          self._methodsBlockingQuiescence[invoker.methodId] = true;                                               // 1098
        }                                                                                                         // 1099
      });                                                                                                         // 1100
    }                                                                                                             // 1101
                                                                                                                  // 1102
    self._messagesBufferedUntilQuiescence = [];                                                                   // 1103
                                                                                                                  // 1104
    // If we're not waiting on any methods or subs, we can reset the stores and                                   // 1105
    // call the callbacks immediately.                                                                            // 1106
    if (!self._waitingForQuiescence()) {                                                                          // 1107
      if (self._resetStores) {                                                                                    // 1108
        _.each(self._stores, function (s) {                                                                       // 1109
          s.beginUpdate(0, true);                                                                                 // 1110
          s.endUpdate();                                                                                          // 1111
        });                                                                                                       // 1112
        self._resetStores = false;                                                                                // 1113
      }                                                                                                           // 1114
      self._runAfterUpdateCallbacks();                                                                            // 1115
    }                                                                                                             // 1116
  },                                                                                                              // 1117
                                                                                                                  // 1118
                                                                                                                  // 1119
  _processOneDataMessage: function (msg, updates) {                                                               // 1120
    var self = this;                                                                                              // 1121
    // Using underscore here so as not to need to capitalize.                                                     // 1122
    self['_process_' + msg.msg](msg, updates);                                                                    // 1123
  },                                                                                                              // 1124
                                                                                                                  // 1125
                                                                                                                  // 1126
  _livedata_data: function (msg) {                                                                                // 1127
    var self = this;                                                                                              // 1128
                                                                                                                  // 1129
    // collection name -> array of messages                                                                       // 1130
    var updates = {};                                                                                             // 1131
                                                                                                                  // 1132
    if (self._waitingForQuiescence()) {                                                                           // 1133
      self._messagesBufferedUntilQuiescence.push(msg);                                                            // 1134
                                                                                                                  // 1135
      if (msg.msg === "nosub")                                                                                    // 1136
        delete self._subsBeingRevived[msg.id];                                                                    // 1137
                                                                                                                  // 1138
      _.each(msg.subs || [], function (subId) {                                                                   // 1139
        delete self._subsBeingRevived[subId];                                                                     // 1140
      });                                                                                                         // 1141
      _.each(msg.methods || [], function (methodId) {                                                             // 1142
        delete self._methodsBlockingQuiescence[methodId];                                                         // 1143
      });                                                                                                         // 1144
                                                                                                                  // 1145
      if (self._waitingForQuiescence())                                                                           // 1146
        return;                                                                                                   // 1147
                                                                                                                  // 1148
      // No methods or subs are blocking quiescence!                                                              // 1149
      // We'll now process and all of our buffered messages, reset all stores,                                    // 1150
      // and apply them all at once.                                                                              // 1151
      _.each(self._messagesBufferedUntilQuiescence, function (bufferedMsg) {                                      // 1152
        self._processOneDataMessage(bufferedMsg, updates);                                                        // 1153
      });                                                                                                         // 1154
      self._messagesBufferedUntilQuiescence = [];                                                                 // 1155
    } else {                                                                                                      // 1156
      self._processOneDataMessage(msg, updates);                                                                  // 1157
    }                                                                                                             // 1158
                                                                                                                  // 1159
    if (self._resetStores || !_.isEmpty(updates)) {                                                               // 1160
      // Begin a transactional update of each store.                                                              // 1161
      _.each(self._stores, function (s, storeName) {                                                              // 1162
        s.beginUpdate(_.has(updates, storeName) ? updates[storeName].length : 0,                                  // 1163
                      self._resetStores);                                                                         // 1164
      });                                                                                                         // 1165
      self._resetStores = false;                                                                                  // 1166
                                                                                                                  // 1167
      _.each(updates, function (updateMessages, storeName) {                                                      // 1168
        var store = self._stores[storeName];                                                                      // 1169
        if (store) {                                                                                              // 1170
          _.each(updateMessages, function (updateMessage) {                                                       // 1171
            store.update(updateMessage);                                                                          // 1172
          });                                                                                                     // 1173
        } else {                                                                                                  // 1174
          // Nobody's listening for this data. Queue it up until                                                  // 1175
          // someone wants it.                                                                                    // 1176
          // XXX memory use will grow without bound if you forget to                                              // 1177
          // create a collection or just don't care about it... going                                             // 1178
          // to have to do something about that.                                                                  // 1179
          if (!_.has(self._updatesForUnknownStores, storeName))                                                   // 1180
            self._updatesForUnknownStores[storeName] = [];                                                        // 1181
          Array.prototype.push.apply(self._updatesForUnknownStores[storeName],                                    // 1182
                                     updateMessages);                                                             // 1183
        }                                                                                                         // 1184
      });                                                                                                         // 1185
                                                                                                                  // 1186
      // End update transaction.                                                                                  // 1187
      _.each(self._stores, function (s) { s.endUpdate(); });                                                      // 1188
    }                                                                                                             // 1189
                                                                                                                  // 1190
    self._runAfterUpdateCallbacks();                                                                              // 1191
  },                                                                                                              // 1192
                                                                                                                  // 1193
  // Call any callbacks deferred with _runWhenAllServerDocsAreFlushed whose                                       // 1194
  // relevant docs have been flushed, as well as dataVisible callbacks at                                         // 1195
  // reconnect-quiescence time.                                                                                   // 1196
  _runAfterUpdateCallbacks: function () {                                                                         // 1197
    var self = this;                                                                                              // 1198
    var callbacks = self._afterUpdateCallbacks;                                                                   // 1199
    self._afterUpdateCallbacks = [];                                                                              // 1200
    _.each(callbacks, function (c) {                                                                              // 1201
      c();                                                                                                        // 1202
    });                                                                                                           // 1203
  },                                                                                                              // 1204
                                                                                                                  // 1205
  _pushUpdate: function (updates, collection, msg) {                                                              // 1206
    var self = this;                                                                                              // 1207
    if (!_.has(updates, collection)) {                                                                            // 1208
      updates[collection] = [];                                                                                   // 1209
    }                                                                                                             // 1210
    updates[collection].push(msg);                                                                                // 1211
  },                                                                                                              // 1212
                                                                                                                  // 1213
  _getServerDoc: function (collection, id) {                                                                      // 1214
    var self = this;                                                                                              // 1215
    if (!_.has(self._serverDocuments, collection))                                                                // 1216
      return null;                                                                                                // 1217
    var serverDocsForCollection = self._serverDocuments[collection];                                              // 1218
    return serverDocsForCollection.get(id) || null;                                                               // 1219
  },                                                                                                              // 1220
                                                                                                                  // 1221
  _process_added: function (msg, updates) {                                                                       // 1222
    var self = this;                                                                                              // 1223
    var id = LocalCollection._idParse(msg.id);                                                                    // 1224
    var serverDoc = self._getServerDoc(msg.collection, id);                                                       // 1225
    if (serverDoc) {                                                                                              // 1226
      // Some outstanding stub wrote here.                                                                        // 1227
      if (serverDoc.document !== undefined)                                                                       // 1228
        throw new Error("Server sent add for existing id: " + msg.id);                                            // 1229
      serverDoc.document = msg.fields || {};                                                                      // 1230
      serverDoc.document._id = id;                                                                                // 1231
    } else {                                                                                                      // 1232
      self._pushUpdate(updates, msg.collection, msg);                                                             // 1233
    }                                                                                                             // 1234
  },                                                                                                              // 1235
                                                                                                                  // 1236
  _process_changed: function (msg, updates) {                                                                     // 1237
    var self = this;                                                                                              // 1238
    var serverDoc = self._getServerDoc(                                                                           // 1239
      msg.collection, LocalCollection._idParse(msg.id));                                                          // 1240
    if (serverDoc) {                                                                                              // 1241
      if (serverDoc.document === undefined)                                                                       // 1242
        throw new Error("Server sent changed for nonexisting id: " + msg.id);                                     // 1243
      LocalCollection._applyChanges(serverDoc.document, msg.fields);                                              // 1244
    } else {                                                                                                      // 1245
      self._pushUpdate(updates, msg.collection, msg);                                                             // 1246
    }                                                                                                             // 1247
  },                                                                                                              // 1248
                                                                                                                  // 1249
  _process_removed: function (msg, updates) {                                                                     // 1250
    var self = this;                                                                                              // 1251
    var serverDoc = self._getServerDoc(                                                                           // 1252
      msg.collection, LocalCollection._idParse(msg.id));                                                          // 1253
    if (serverDoc) {                                                                                              // 1254
      // Some outstanding stub wrote here.                                                                        // 1255
      if (serverDoc.document === undefined)                                                                       // 1256
        throw new Error("Server sent removed for nonexisting id:" + msg.id);                                      // 1257
      serverDoc.document = undefined;                                                                             // 1258
    } else {                                                                                                      // 1259
      self._pushUpdate(updates, msg.collection, {                                                                 // 1260
        msg: 'removed',                                                                                           // 1261
        collection: msg.collection,                                                                               // 1262
        id: msg.id                                                                                                // 1263
      });                                                                                                         // 1264
    }                                                                                                             // 1265
  },                                                                                                              // 1266
                                                                                                                  // 1267
  _process_updated: function (msg, updates) {                                                                     // 1268
    var self = this;                                                                                              // 1269
    // Process "method done" messages.                                                                            // 1270
    _.each(msg.methods, function (methodId) {                                                                     // 1271
      _.each(self._documentsWrittenByStub[methodId], function (written) {                                         // 1272
        var serverDoc = self._getServerDoc(written.collection, written.id);                                       // 1273
        if (!serverDoc)                                                                                           // 1274
          throw new Error("Lost serverDoc for " + JSON.stringify(written));                                       // 1275
        if (!serverDoc.writtenByStubs[methodId])                                                                  // 1276
          throw new Error("Doc " + JSON.stringify(written) +                                                      // 1277
                          " not written by  method " + methodId);                                                 // 1278
        delete serverDoc.writtenByStubs[methodId];                                                                // 1279
        if (_.isEmpty(serverDoc.writtenByStubs)) {                                                                // 1280
          // All methods whose stubs wrote this method have completed! We can                                     // 1281
          // now copy the saved document to the database (reverting the stub's                                    // 1282
          // change if the server did not write to this object, or applying the                                   // 1283
          // server's writes if it did).                                                                          // 1284
                                                                                                                  // 1285
          // This is a fake ddp 'replace' message.  It's just for talking                                         // 1286
          // between livedata connections and minimongo.  (We have to stringify                                   // 1287
          // the ID because it's supposed to look like a wire message.)                                           // 1288
          self._pushUpdate(updates, written.collection, {                                                         // 1289
            msg: 'replace',                                                                                       // 1290
            id: LocalCollection._idStringify(written.id),                                                         // 1291
            replace: serverDoc.document                                                                           // 1292
          });                                                                                                     // 1293
          // Call all flush callbacks.                                                                            // 1294
          _.each(serverDoc.flushCallbacks, function (c) {                                                         // 1295
            c();                                                                                                  // 1296
          });                                                                                                     // 1297
                                                                                                                  // 1298
          // Delete this completed serverDocument. Don't bother to GC empty                                       // 1299
          // IdMaps inside self._serverDocuments, since there probably aren't                                     // 1300
          // many collections and they'll be written repeatedly.                                                  // 1301
          self._serverDocuments[written.collection].remove(written.id);                                           // 1302
        }                                                                                                         // 1303
      });                                                                                                         // 1304
      delete self._documentsWrittenByStub[methodId];                                                              // 1305
                                                                                                                  // 1306
      // We want to call the data-written callback, but we can't do so until all                                  // 1307
      // currently buffered messages are flushed.                                                                 // 1308
      var callbackInvoker = self._methodInvokers[methodId];                                                       // 1309
      if (!callbackInvoker)                                                                                       // 1310
        throw new Error("No callback invoker for method " + methodId);                                            // 1311
      self._runWhenAllServerDocsAreFlushed(                                                                       // 1312
        _.bind(callbackInvoker.dataVisible, callbackInvoker));                                                    // 1313
    });                                                                                                           // 1314
  },                                                                                                              // 1315
                                                                                                                  // 1316
  _process_ready: function (msg, updates) {                                                                       // 1317
    var self = this;                                                                                              // 1318
    // Process "sub ready" messages. "sub ready" messages don't take effect                                       // 1319
    // until all current server documents have been flushed to the local                                          // 1320
    // database. We can use a write fence to implement this.                                                      // 1321
    _.each(msg.subs, function (subId) {                                                                           // 1322
      self._runWhenAllServerDocsAreFlushed(function () {                                                          // 1323
        var subRecord = self._subscriptions[subId];                                                               // 1324
        // Did we already unsubscribe?                                                                            // 1325
        if (!subRecord)                                                                                           // 1326
          return;                                                                                                 // 1327
        // Did we already receive a ready message? (Oops!)                                                        // 1328
        if (subRecord.ready)                                                                                      // 1329
          return;                                                                                                 // 1330
        subRecord.readyCallback && subRecord.readyCallback();                                                     // 1331
        subRecord.ready = true;                                                                                   // 1332
        subRecord.readyDeps.changed();                                                                            // 1333
      });                                                                                                         // 1334
    });                                                                                                           // 1335
  },                                                                                                              // 1336
                                                                                                                  // 1337
  // Ensures that "f" will be called after all documents currently in                                             // 1338
  // _serverDocuments have been written to the local cache. f will not be called                                  // 1339
  // if the connection is lost before then!                                                                       // 1340
  _runWhenAllServerDocsAreFlushed: function (f) {                                                                 // 1341
    var self = this;                                                                                              // 1342
    var runFAfterUpdates = function () {                                                                          // 1343
      self._afterUpdateCallbacks.push(f);                                                                         // 1344
    };                                                                                                            // 1345
    var unflushedServerDocCount = 0;                                                                              // 1346
    var onServerDocFlush = function () {                                                                          // 1347
      --unflushedServerDocCount;                                                                                  // 1348
      if (unflushedServerDocCount === 0) {                                                                        // 1349
        // This was the last doc to flush! Arrange to run f after the updates                                     // 1350
        // have been applied.                                                                                     // 1351
        runFAfterUpdates();                                                                                       // 1352
      }                                                                                                           // 1353
    };                                                                                                            // 1354
    _.each(self._serverDocuments, function (collectionDocs) {                                                     // 1355
      collectionDocs.forEach(function (serverDoc) {                                                               // 1356
        var writtenByStubForAMethodWithSentMessage = _.any(                                                       // 1357
          serverDoc.writtenByStubs, function (dummy, methodId) {                                                  // 1358
            var invoker = self._methodInvokers[methodId];                                                         // 1359
            return invoker && invoker.sentMessage;                                                                // 1360
          });                                                                                                     // 1361
        if (writtenByStubForAMethodWithSentMessage) {                                                             // 1362
          ++unflushedServerDocCount;                                                                              // 1363
          serverDoc.flushCallbacks.push(onServerDocFlush);                                                        // 1364
        }                                                                                                         // 1365
      });                                                                                                         // 1366
    });                                                                                                           // 1367
    if (unflushedServerDocCount === 0) {                                                                          // 1368
      // There aren't any buffered docs --- we can call f as soon as the current                                  // 1369
      // round of updates is applied!                                                                             // 1370
      runFAfterUpdates();                                                                                         // 1371
    }                                                                                                             // 1372
  },                                                                                                              // 1373
                                                                                                                  // 1374
  _livedata_nosub: function (msg) {                                                                               // 1375
    var self = this;                                                                                              // 1376
                                                                                                                  // 1377
    // First pass it through _livedata_data, which only uses it to help get                                       // 1378
    // towards quiescence.                                                                                        // 1379
    self._livedata_data(msg);                                                                                     // 1380
                                                                                                                  // 1381
    // Do the rest of our processing immediately, with no                                                         // 1382
    // buffering-until-quiescence.                                                                                // 1383
                                                                                                                  // 1384
    // we weren't subbed anyway, or we initiated the unsub.                                                       // 1385
    if (!_.has(self._subscriptions, msg.id))                                                                      // 1386
      return;                                                                                                     // 1387
    var errorCallback = self._subscriptions[msg.id].errorCallback;                                                // 1388
    self._subscriptions[msg.id].remove();                                                                         // 1389
    if (errorCallback && msg.error) {                                                                             // 1390
      errorCallback(new Meteor.Error(                                                                             // 1391
        msg.error.error, msg.error.reason, msg.error.details));                                                   // 1392
    }                                                                                                             // 1393
  },                                                                                                              // 1394
                                                                                                                  // 1395
  _process_nosub: function () {                                                                                   // 1396
    // This is called as part of the "buffer until quiescence" process, but                                       // 1397
    // nosub's effect is always immediate. It only goes in the buffer at all                                      // 1398
    // because it's possible for a nosub to be the thing that triggers                                            // 1399
    // quiescence, if we were waiting for a sub to be revived and it dies                                         // 1400
    // instead.                                                                                                   // 1401
  },                                                                                                              // 1402
                                                                                                                  // 1403
  _livedata_result: function (msg) {                                                                              // 1404
    // id, result or error. error has error (code), reason, details                                               // 1405
                                                                                                                  // 1406
    var self = this;                                                                                              // 1407
                                                                                                                  // 1408
    // find the outstanding request                                                                               // 1409
    // should be O(1) in nearly all realistic use cases                                                           // 1410
    if (_.isEmpty(self._outstandingMethodBlocks)) {                                                               // 1411
      Meteor._debug("Received method result but no methods outstanding");                                         // 1412
      return;                                                                                                     // 1413
    }                                                                                                             // 1414
    var currentMethodBlock = self._outstandingMethodBlocks[0].methods;                                            // 1415
    var m;                                                                                                        // 1416
    for (var i = 0; i < currentMethodBlock.length; i++) {                                                         // 1417
      m = currentMethodBlock[i];                                                                                  // 1418
      if (m.methodId === msg.id)                                                                                  // 1419
        break;                                                                                                    // 1420
    }                                                                                                             // 1421
                                                                                                                  // 1422
    if (!m) {                                                                                                     // 1423
      Meteor._debug("Can't match method response to original method call", msg);                                  // 1424
      return;                                                                                                     // 1425
    }                                                                                                             // 1426
                                                                                                                  // 1427
    // Remove from current method block. This may leave the block empty, but we                                   // 1428
    // don't move on to the next block until the callback has been delivered, in                                  // 1429
    // _outstandingMethodFinished.                                                                                // 1430
    currentMethodBlock.splice(i, 1);                                                                              // 1431
                                                                                                                  // 1432
    if (_.has(msg, 'error')) {                                                                                    // 1433
      m.receiveResult(new Meteor.Error(                                                                           // 1434
        msg.error.error, msg.error.reason,                                                                        // 1435
        msg.error.details));                                                                                      // 1436
    } else {                                                                                                      // 1437
      // msg.result may be undefined if the method didn't return a                                                // 1438
      // value                                                                                                    // 1439
      m.receiveResult(undefined, msg.result);                                                                     // 1440
    }                                                                                                             // 1441
  },                                                                                                              // 1442
                                                                                                                  // 1443
  // Called by MethodInvoker after a method's callback is invoked.  If this was                                   // 1444
  // the last outstanding method in the current block, runs the next block. If                                    // 1445
  // there are no more methods, consider accepting a hot code push.                                               // 1446
  _outstandingMethodFinished: function () {                                                                       // 1447
    var self = this;                                                                                              // 1448
    if (self._anyMethodsAreOutstanding())                                                                         // 1449
      return;                                                                                                     // 1450
                                                                                                                  // 1451
    // No methods are outstanding. This should mean that the first block of                                       // 1452
    // methods is empty. (Or it might not exist, if this was a method that                                        // 1453
    // half-finished before disconnect/reconnect.)                                                                // 1454
    if (! _.isEmpty(self._outstandingMethodBlocks)) {                                                             // 1455
      var firstBlock = self._outstandingMethodBlocks.shift();                                                     // 1456
      if (! _.isEmpty(firstBlock.methods))                                                                        // 1457
        throw new Error("No methods outstanding but nonempty block: " +                                           // 1458
                        JSON.stringify(firstBlock));                                                              // 1459
                                                                                                                  // 1460
      // Send the outstanding methods now in the first block.                                                     // 1461
      if (!_.isEmpty(self._outstandingMethodBlocks))                                                              // 1462
        self._sendOutstandingMethods();                                                                           // 1463
    }                                                                                                             // 1464
                                                                                                                  // 1465
    // Maybe accept a hot code push.                                                                              // 1466
    self._maybeMigrate();                                                                                         // 1467
  },                                                                                                              // 1468
                                                                                                                  // 1469
  // Sends messages for all the methods in the first block in                                                     // 1470
  // _outstandingMethodBlocks.                                                                                    // 1471
  _sendOutstandingMethods: function() {                                                                           // 1472
    var self = this;                                                                                              // 1473
    if (_.isEmpty(self._outstandingMethodBlocks))                                                                 // 1474
      return;                                                                                                     // 1475
    _.each(self._outstandingMethodBlocks[0].methods, function (m) {                                               // 1476
      m.sendMessage();                                                                                            // 1477
    });                                                                                                           // 1478
  },                                                                                                              // 1479
                                                                                                                  // 1480
  _livedata_error: function (msg) {                                                                               // 1481
    Meteor._debug("Received error from server: ", msg.reason);                                                    // 1482
    if (msg.offendingMessage)                                                                                     // 1483
      Meteor._debug("For: ", msg.offendingMessage);                                                               // 1484
  },                                                                                                              // 1485
                                                                                                                  // 1486
  _callOnReconnectAndSendAppropriateOutstandingMethods: function() {                                              // 1487
    var self = this;                                                                                              // 1488
    var oldOutstandingMethodBlocks = self._outstandingMethodBlocks;                                               // 1489
    self._outstandingMethodBlocks = [];                                                                           // 1490
                                                                                                                  // 1491
    self.onReconnect();                                                                                           // 1492
                                                                                                                  // 1493
    if (_.isEmpty(oldOutstandingMethodBlocks))                                                                    // 1494
      return;                                                                                                     // 1495
                                                                                                                  // 1496
    // We have at least one block worth of old outstanding methods to try                                         // 1497
    // again. First: did onReconnect actually send anything? If not, we just                                      // 1498
    // restore all outstanding methods and run the first block.                                                   // 1499
    if (_.isEmpty(self._outstandingMethodBlocks)) {                                                               // 1500
      self._outstandingMethodBlocks = oldOutstandingMethodBlocks;                                                 // 1501
      self._sendOutstandingMethods();                                                                             // 1502
      return;                                                                                                     // 1503
    }                                                                                                             // 1504
                                                                                                                  // 1505
    // OK, there are blocks on both sides. Special case: merge the last block of                                  // 1506
    // the reconnect methods with the first block of the original methods, if                                     // 1507
    // neither of them are "wait" blocks.                                                                         // 1508
    if (!_.last(self._outstandingMethodBlocks).wait &&                                                            // 1509
        !oldOutstandingMethodBlocks[0].wait) {                                                                    // 1510
      _.each(oldOutstandingMethodBlocks[0].methods, function (m) {                                                // 1511
        _.last(self._outstandingMethodBlocks).methods.push(m);                                                    // 1512
                                                                                                                  // 1513
        // If this "last block" is also the first block, send the message.                                        // 1514
        if (self._outstandingMethodBlocks.length === 1)                                                           // 1515
          m.sendMessage();                                                                                        // 1516
      });                                                                                                         // 1517
                                                                                                                  // 1518
      oldOutstandingMethodBlocks.shift();                                                                         // 1519
    }                                                                                                             // 1520
                                                                                                                  // 1521
    // Now add the rest of the original blocks on.                                                                // 1522
    _.each(oldOutstandingMethodBlocks, function (block) {                                                         // 1523
      self._outstandingMethodBlocks.push(block);                                                                  // 1524
    });                                                                                                           // 1525
  },                                                                                                              // 1526
                                                                                                                  // 1527
  // We can accept a hot code push if there are no methods in flight.                                             // 1528
  _readyToMigrate: function() {                                                                                   // 1529
    var self = this;                                                                                              // 1530
    return _.isEmpty(self._methodInvokers);                                                                       // 1531
  },                                                                                                              // 1532
                                                                                                                  // 1533
  // If we were blocking a migration, see if it's now possible to continue.                                       // 1534
  // Call whenever the set of outstanding/blocked methods shrinks.                                                // 1535
  _maybeMigrate: function () {                                                                                    // 1536
    var self = this;                                                                                              // 1537
    if (self._retryMigrate && self._readyToMigrate()) {                                                           // 1538
      self._retryMigrate();                                                                                       // 1539
      self._retryMigrate = null;                                                                                  // 1540
    }                                                                                                             // 1541
  }                                                                                                               // 1542
});                                                                                                               // 1543
                                                                                                                  // 1544
LivedataTest.Connection = Connection;                                                                             // 1545
                                                                                                                  // 1546
// @param url {String} URL to Meteor app,                                                                         // 1547
//     e.g.:                                                                                                      // 1548
//     "subdomain.meteor.com",                                                                                    // 1549
//     "http://subdomain.meteor.com",                                                                             // 1550
//     "/",                                                                                                       // 1551
//     "ddp+sockjs://ddp--****-foo.meteor.com/sockjs"                                                             // 1552
                                                                                                                  // 1553
/**                                                                                                               // 1554
 * @summary Connect to the server of a different Meteor application to subscribe to its document sets and invoke its remote methods.
 * @locus Anywhere                                                                                                // 1556
 * @param {String} url The URL of another Meteor application.                                                     // 1557
 */                                                                                                               // 1558
DDP.connect = function (url, options) {                                                                           // 1559
  var ret = new Connection(url, options);                                                                         // 1560
  allConnections.push(ret); // hack. see below.                                                                   // 1561
  return ret;                                                                                                     // 1562
};                                                                                                                // 1563
                                                                                                                  // 1564
// Hack for `spiderable` package: a way to see if the page is done                                                // 1565
// loading all the data it needs.                                                                                 // 1566
//                                                                                                                // 1567
allConnections = [];                                                                                              // 1568
DDP._allSubscriptionsReady = function () {                                                                        // 1569
  return _.all(allConnections, function (conn) {                                                                  // 1570
    return _.all(conn._subscriptions, function (sub) {                                                            // 1571
      return sub.ready;                                                                                           // 1572
    });                                                                                                           // 1573
  });                                                                                                             // 1574
};                                                                                                                // 1575
                                                                                                                  // 1576
