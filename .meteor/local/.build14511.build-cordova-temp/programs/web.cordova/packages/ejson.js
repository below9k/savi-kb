...
var builtinConverters = [                                                                                            // 34
  ...
  { // Binary                                                                                                        // 69
    ...
    toJSONValue: function (obj) {                                                                                    // 77
      return {$binary: Base64.encode(obj)};                                                                          // 78
    },                                                                                                               // 79
    fromJSONValue: function (obj) {                                                                                  // 80
      return Base64.decode(obj.$binary);                                                                             // 81
    }                                                                                                                // 82
  },                                                                                                                 // 83
...
EJSON.clone = function (v) {                                                                                         // 407
  ...
  return ret;                                                                                                        // 448
                                                                                                                     ...
                                                                                                                     // 450
/**                                                                                                                  // 451
 * @summary Allocate a new buffer of binary data that EJSON can serialize.                                           // 452
 * @locus Anywhere                                                                                                   // 453
 * @param {Number} size The number of bytes of binary data to allocate.                                              // 454
 */                                                                                                                  // 455
// EJSON.newBinary is the public documented API for this functionality,                                              // 456
// but the implementation is in the 'base64' package to avoid                                                        // 457
// introducing a circular dependency. (If the implementation were here,                                              // 458
// then 'base64' would have to use EJSON.newBinary, and 'ejson' would                                                // 459
// also have to use 'base64'.)                                                                                       // 460
EJSON.newBinary = Base64.newBinary;                                                                                  // 461
                                                                                                                     // 462
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
